...
$phones = [
    [ 
     ...
     'img_url' =>'https://th.bing.com/th/id/OIP.ujG7HAzxcXm7ygGp6sSvXwHaE8?rs=1&pid=ImgDetMain',
    'rate' => '5',
    'brand' => 'Samsung',
    'price' => 'JOD 759.00',
    'is_out_of_stock' => '1'
...
foreach($phones as $phone){
    ...
    echo "<h3 class='card-title'>" .$phone['name']."</h3>" . "<br>" ;
    echo "<img src='" . $phone['img_url'] ."' style='width: 220px; height: auto;'><br>";
    echo $phone['rate'] . "<br>";
    echo "<strong>Brand:</strong> ". $phone['brand'] . "<br>";
    echo $phone['price'] . "<br>";
